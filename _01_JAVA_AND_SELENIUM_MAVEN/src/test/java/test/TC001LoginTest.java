...
public class TC001LoginTest extends _projectSpecific_LetCodeBase{
	@Test
	public void login() throws InterruptedException {
		...
		login.enterUserEmail("koushik350@gmail.com");
		login.enterPassword("Pass123$");
		login.clickLogin();
		Thread.sleep(3000);
		String toastMessage = home.validateToastMessage();
		System.out.println(toastMessage);
		Assert.assertEquals(toastMessage.trim(), "Welcome Koushik Chatterjee");
	}
