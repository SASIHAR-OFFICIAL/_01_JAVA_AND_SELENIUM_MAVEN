...
public class _LetCode_org_letcode_pages_LoginPage extends _projectSpecific_LetCodeBase{
...
//	String text = "Signin"
	...
	public _LetCode_org_letcode_pages_LoginPage(RemoteWebDriver driver) {
		this.driver = driver;
